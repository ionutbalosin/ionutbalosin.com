...
- [Xavier Rene-Corail and myself were interviewed by InfoQ online publication. Below is our interview.](#xavier-rene-corail-and-myself-were-interviewed-by-infoq-online-publication-below-is-our-interview)
- [InfoQ: What made you decide to adopt agile?](#infoq-what-made-you-decide-to-adopt-agile)
- [InfoQ: Do you have some examples of how you apply agile practices in a distributed way?](#infoq-do-you-have-some-examples-of-how-you-apply-agile-practices-in-a-distributed-way)
- [InfoQ: People sometimes give up on agile practices when they experience difficulties. Can you give some examples?](#infoq-people-sometimes-give-up-on-agile-practices-when-they-experience-difficulties-can-you-give-some-examples)
- [InfoQ: You mentioned in your talk that instead of removing practices that were difficult, you decided to stretch them. Why did you take this approach?](#infoq-you-mentioned-in-your-talk-that-instead-of-removing-practices-that-were-difficult-you-decided-to-stretch-them-why-did-you-take-this-approach)
...
Xavier Rene-Corail, Software Engineering Lead and Agile Catalyst at Murex and Ionuț Baloșin, Certified Scrum Master and Software Architect at Luxoft spoke about stretching agile at the [XP Days Benelux 2016](http://www.xpday.net/2016/).
...
> **Ionut Balosin**: We also faced a situation when somebody decided to switch to another project because he did not like to work using agile and all the practices around it. It was an isolated case which did not even discourage us. On the contrary, we decided to continuously improve our agile practices by reducing the flaws and making the processes more efficient.
