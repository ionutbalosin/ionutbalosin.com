...
![Authentication and Authorization](authentication_and_authorization.svg)
...
![API and Microservices Security.svg](api_and_microservices_security.svg)
...
![Token Introspection.svg](token_introspection.svg)
...
![JSON Web Key Set (JWKS)](jwks.svg)
...
![CORS User Case.svg](cors_headers_use_case.svg)
...
![CORS Preflight Request.svg](cors_headers_preflight.svg)

The high-level CORS preflight request sequence diagram looks like this:

![CORS Preflight Request.svg](cors_headers_preflight_sequence_diagram.svg)
...
![HTTP Strict Transport Security.svg](strict_transport_security_header.svg)
...
![X-XSS-Protection.svg](x_xss_protection_header.svg)
...
![X-Frame-Options.svg](x_frame_options_header.svg)
...
![X-Content-Type-Options.svg](x_content_type_options_header.svg)
...
![Referrer-Policy.svg](referrer_policy_header.svg)
